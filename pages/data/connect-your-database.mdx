...
The below is a `CREATE` action, but all `CRUD` operations are available, with sample scripts in [your repo](https://github.com/embeddable-hq/embeddable-boilerplate/tree/main/src/embeddable.com/scripts) and postman-style scripts in Bruno, above.
