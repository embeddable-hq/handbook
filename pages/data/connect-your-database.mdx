...
<Bruno/>
 ...
 - Or you can use the handy sample javascript scripts in [your repo](https://github.com/embeddable-hq/embeddable-boilerplate/tree/main/src/embeddable.com/scripts).
