...
<Callout emoji="💡">
  Using **Cube Cloud** or your own **Cube Core** deployment instead of Embeddable's built-in Cube? See [Bring your own Cube](/data/bring-your-own-cube) — this page (and the rest of the **Connect your data** section) does not apply to you.
</Callout>
...
<Callout emoji="⚠️">
Leave enough headroom in your database's own max connection limit for other applications connecting to the same database. Setting `concurrency` higher than your database can support may cause connection errors instead of faster queries.
</Callout>
...
Send us these details using [PrivateBin](https://privatebin.eu.embeddable.com/) — do not send them by email or chat. Paste the details, set an expiry, and share the link with us.
...
- You share the service name with us using [PrivateBin](https://privatebin.eu.embeddable.com/)
