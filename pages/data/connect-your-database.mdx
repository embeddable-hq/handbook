...
- **IP whitelisting:** Restrict access to your database by allowing only Embeddable’s fixed IPs ([EU](/getting-started/deployment-regions/us#ips-to-whitelist), [US](/getting-started/deployment-regions/eu#ips-to-whitelist)).
