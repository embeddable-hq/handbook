...
To preview environments **before** publishing, you can create or update your `src/presets/security-contexts.sc.yml` ([here](https://github.com/embeddable-hq/vanilla-components/blob/main/src/presets/security-contexts.sc.yml)) with entries specifying the `environment`:
   ```yaml
