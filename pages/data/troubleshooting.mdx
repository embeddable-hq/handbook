...
2. **Firewall or Network Restrictions** 
    - Ensure your database server allows incoming connections from Embeddable’s IP addresses ([EU](/getting-started/deployment-regions/us#ips-to-whitelist), [US](/getting-started/deployment-regions/eu#ips-to-whitelist)).  
