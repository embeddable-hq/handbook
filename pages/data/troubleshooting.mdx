...
<Callout emoji="💡">
  Using **Cube Cloud** or your own **Cube Core** deployment instead of Embeddable's built-in Cube? This page does not apply to you. See [Bring your own Cube](/data/bring-your-own-cube) instead.
</Callout>
