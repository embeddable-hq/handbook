...
**Things to notice:**
 ...
 - [1:35] You can switch between **security contexts** using the [View As](/data-modeling/row-level-security/sql-based-security#testing-your-sql-based-security) dropdown.

**Notes and best practices**

- The `dataProvider` you add in your [**security context**](/data-modeling/row-level-security/sql-based-security#testing-your-sql-based-security) file or [**Tokens API**](/deployment/tokens-api) request must match the data provider you created using the [**Data Providers API**](/data/cube-cloud#data-provider-api).
...
Firstly, we'll create a new branch called `add_completed_percentage_measure`. In this branch, we'll add a new ***"completed percentage"*** measure to our `base_orders` model and include it in the `orders` [**view**](/data-modeling/writing-data-models/views).
...
- You can test this new measure in [data playground](/data-modeling/testing-models) or [dashboard](/dashboards/introduction) before merging it to your main branch.
