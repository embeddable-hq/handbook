...
- An Embeddable with a chart where users will click
- A **dependent Embeddable** to open in the modal (a single chart or full dashboard)
- Optionally, [variables](/dashboards/interactivity) defined in your dependent Embeddable for filtering

<Callout emoji="💡">
  Create your dependent Embeddables first—they must exist before they can be selected in the drill-down configuration.
</Callout>

### Step 1: Create a dependent Embeddable

The dependent Embeddable is the view that opens when a user clicks. Follow these steps to build and test it before wiring up the drill-down.
...
- Click **Add variable** and configure it
- Give it a default value for testing

### Connect the variable to your dataset

Edit your chart component and add a filter using your variable.
...
<ImageGrid width='100%' images={["/img/drill-down-choose.jpg"]}/>
...
<Callout emoji="⚠️">
  You must publish all dependent Embeddables before publishing the main Embeddable. If a dependent Embeddable isn't published to an environment, the drill-down won't work for users in that environment.
</Callout>
