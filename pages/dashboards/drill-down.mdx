...
The dependent Embeddable is the view that opens when a user clicks. This must be created first, as it must exist before it can be selected later. Follow these steps to build and test it before wiring up the drill-down.
