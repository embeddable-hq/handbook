...
<Callout emoji="🎥">
  Learn more about debugging your Embeddable components in our [Quick Hits video tutorial on the Debug Button](/video-tutorials/quick-hits/debug-button).
</Callout>
...
The Console is also available when [developing locally](/getting-started/development/local-environment). 