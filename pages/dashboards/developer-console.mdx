...
Embeddable provides a **developer console** that logs the key events and requests occurring inside your dashboard, making it easier to debug or optimize. 

In this console, you’ll see,
