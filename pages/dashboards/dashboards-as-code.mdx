...
**Dashboards as Code** lets you define Embeddable dashboards directly in your codebase using `.<dashboard-name>.embeddable.yml` files. These files can be stored in git, iterated on by your team or with LLMs, and previewed live in the browser via [`embeddable:dev`](/getting-started/dev-server).
