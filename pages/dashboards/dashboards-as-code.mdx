...
<Callout emoji="💡">
You can download any existing dashboard as YAML, even if it wasn't originally created as code. This is a great way to quickly convert a no-code dashboard into a coded one that you can iterate on in your repo. Note that **this will overwrite the non-code version** in the workspace. You can avoid this by renaming either the original or the in-code version after downloading and before pushing your changes to your workspace.
</Callout>
