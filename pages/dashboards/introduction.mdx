...
1. **Define Components & Models in Code**  
   - Your technical teams build [React components](/component-libraries/build-components/defining-components) (e.g. charts, controls) and [data models](/data-modeling/introduction), then [push them](/getting-started/development/pushing-code) to Embeddable.  

2. **Build Dashboards with Drag & Drop**  
   - **Add** a component (like a line chart or dropdown) onto the canvas.  
   - **Customize** it using the [inputs](/component-libraries/build-components/defining-components#configure-in-embts) available - your team have full control over these.
...
5. **Test Security Contexts**  
   - Switch between different [security-contexts](/data-modeling/row-level-security/security-filters#testing-your-security-filters) (e.g. “User A” or “User B”) and [environments](/data/environments), seeing the exact data and set up your users see.
