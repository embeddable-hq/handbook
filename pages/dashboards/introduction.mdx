...
1. **Define Components & Models in Code**  
   Your technical teams build [React components](/development/defining-components) (e.g. charts, controls) and [data models](/data-modeling/defining-models), then [push them](/development/pushing-code) to Embeddable.  
...
5. **Test Security Contexts**  
   - Switch between different [security-contexts](/data-modeling/row-level-security#testing-security-contexts-in-embeddable) (e.g. “User A” or “User B”) and [environments](/deployment/environments-api#testing-in-the-no-code-builder), seeing the exact data and set up your users see. 
