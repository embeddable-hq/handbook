...
The last thirty saved versions are listed in the dropdown, with the most recent at the top. You can select any saved version to load it into the builder. Note that if you have not saved your most recent changes, you will be prompted to confirm before switching, as doing so will overwrite them.
