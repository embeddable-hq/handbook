...
<CardGrid>
  <LinkCard title="Import starter components into your workspace" href="/getting-started/get-set-up/set-up-your-workspace#download-our-boilerplate-repo" icon="🐙"/> 
  <LinkCard title="Learn how to build and extend components" href="/getting-started/development/introduction" icon="⚡"/>
</CardGrid> 
