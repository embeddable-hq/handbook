...
1. **Datasets**: the data you wish to show. 
2. **Components**: your charting visualizations.   
...
<Callout emoji="💡">
  Because data models include row-level security rules and transformations, everyone sees the right data automatically, so this **isn't something you need to consider** in the no-code builder. 
</Callout>
...
When you add or reposition components, Embeddable’s **canvas** automatically arranges them based on a **grid layout** with a few key properties:
...
- **Responsive Breakpoints**: The canvas adapts for mobile or smaller screens. These breakpoints currently **can’t** be edited. 
