...
- How to enable **Custom Canvas** for your Embeddable dashboard.
...
If you're looking, instead, for **how to deploy Custom Canvas**, [click here](/deployment/custom-canvas).
