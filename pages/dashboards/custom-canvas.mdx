...
How it works:
- You choose which **datasets**, **dimensions** and **measures** should be available to your end-users.
- You choose (and customize) the **charts, tables** and **components** that your end-users can use to **build their dashboards**.

(you'll learn how [below](#how-you-build-it))

Embeddable handles the rest:
