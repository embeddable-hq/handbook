...
<Callout icon="💡">
  Because of the way `defineComponent` works, the third parameter, the object
  that defines props and events, must be delivered inline (i.e. not as a
  separate variable). This prevents build errors.
</Callout>
