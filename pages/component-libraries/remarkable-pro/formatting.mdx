...
For a full reference of all `meta` keys supported by Remarkable Pro — including chart behaviour options like `aggType` — see [Data Model Meta](/component-libraries/remarkable-pro/data-model-meta).