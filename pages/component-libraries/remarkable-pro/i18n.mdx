...
You can pass this context into Embeddable (or switch between contexts dynamically) using [Client Context](/component-libraries/client-context).
...
You can see the full list of labels in the Remarkable Pro [German translation file](https://github.com/embeddable-hq/remarkable-pro/blob/main/src/theme/i18n/translations/de.ts). You can translate these into other languages by providing translations using the format shown [above](/component-libraries/remarkable-pro/i18n#language).  
