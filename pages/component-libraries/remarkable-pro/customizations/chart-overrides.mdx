...
## Limitations
- Some Chart.js options rely on specific plugins. If a plugin is not used by Remarkable, options related to that plugin will not work. You can see exactly which plugins are included [here](https://github.com/embeddable-hq/remarkable-ui/blob/main/package-lock.json).