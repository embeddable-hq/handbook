...
- If you want the new option to appear in Embeddable’s Builder as well (for example, to select it as a default filter), you’ll also need to extend Embeddable’s native `timerange` types. Learn more about this [here](/component-libraries/build-components/extending-types). 
