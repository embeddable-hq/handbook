...
<Pill><span>Takes ~5 mins</span></Pill>
...
- **Browse the [Component token lists](https://github.com/embeddable-hq/remarkable-ui/blob/main/src/styles/global.tokens.ts)** in the Remarkable UI repo to understand everything that can be customized for each component.
