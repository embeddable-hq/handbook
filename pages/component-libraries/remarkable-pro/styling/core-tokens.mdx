...
Visit the [Remarkable Pro showcase](https://remarkable.embeddable.com/) to see how core tokens are used throughout the component system.
...
### Borders
  ...
  You can change the default font by configuring [custom fonts](/component-libraries/remarkable-pro/styling/fonts) in your theme.
