...
By default, Semantic tokens sit on top of the [Core layer](/component-libraries/remarkable-pro/styling/core-variables), mapping design primitives into meaningful UI roles. But, you’re not limited to referencing Core tokens. You can assign **any valid CSS value**:
