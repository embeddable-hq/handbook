...
<Callout emoji="💡">
Building dashboards instead? See [Build dashboards with AI](/dashboards/build-with-ai) — the same idea, applied to your `.embeddable.yml` files. Modeling the data? See [Build data models with AI](/data-modeling/build-with-ai).
</Callout>
