...
[Custom Canvas](/self-serve/custom-canvas) is a feature that lets your users build their own dashboards inside your product. This page covers **styling** its interface; see also [Deploying Custom Canvas](/deployment/custom-canvas).
