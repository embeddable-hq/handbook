...
To start using the data model editor simply make sure that you've [set up your workspace](/getting-started/get-set-up/your-workspace) and then head to the **Data Model Editor** tab:
...
1. Learn more [here](/data-modeling/writing-data-models/defining-models).
...
1. **In the same repository** as your charting components (like [this](https://github.com/embeddable-hq/remarkable-pro-boilerplate/tree/main/src/embeddable.com/models)).
...
For a reference setup, take a look at our [starter repo](/getting-started/get-set-up/set-up-your-workspace). It demonstrates a typical way to organize your files. 
...
```
- This ensures that, when you [push your models](/getting-started/development/pushing-code) to your Embeddable workspace, only relevant model files are sent. 

- Importantly, this also includes any [security context presets](/data-modeling/row-level-security/security-filters#testing-your-security-filters) you've created to test row-level security.
