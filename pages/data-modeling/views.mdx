...
- Define a **clean facade** on top of your data models.
...
- **Clutter**: Views allow you to represent different **subsets** of your connected Cubes graph as individual Views (e.g. you could have just a Marketing view, a Sales View and an Admin view).  You can even have different names, for each measure and dimension, for each View.
