...
**Access Policies** let you control which rows of data a user can see in Embeddable by defining them in [cube models](/data-modelling/defining-models) or [views](/data-modeling/views). They are applied at query time and affect [dashboards](/dashboards/introduction) and [data playground](/data-modeling/testing-models).
