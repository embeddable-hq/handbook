...
You can define your models using YAML or JavaScript. In most cases, YAML is recommended for its simplicity and readability. (See [Cube’s documentation](https://cube.dev/docs/product/data-modeling/overview) if you prefer JavaScript-based models.)

You can store your model files either alongside your charting components in the [same repository](/getting-started/download-starter-repo), or separately in their own repository. Embeddable supports both structures. Since models and components have independent versioning, you can also [push updates to each separately](/development/pushing-code), giving you full flexibility.
