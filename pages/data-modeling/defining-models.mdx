...
Whether you're defining your models in the **Data Model Editor** or directly **in code**, in the end you're creating a model file that looks something like this:
