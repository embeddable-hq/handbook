...
You can define data models using either yaml or javascript. Generally, yaml is recommended due to its simplicity and readability. On this page, we focus exclusively on yaml. 
...
- `data_source`: Specifies which data source the model belongs to. This should match the connection name you defined when [connecting your database](/getting-started/connect-your-database).
