...
When using Embeddable's no-code dashboard builder, you'll be able to **use your models to populate data for charts** and other components e.g. a pie chart that shows a count of customers grouped by country.  You don't need to worry about writing SQL - it gets generated behind the scenes automatically based on your models. 
...
Once you've defined your data models, [push them to your Embeddable workspace](TODO) to make them available in the no-code dashboard builder. 

When you add a charting component (e.g. a pie chart or a dropdown) to a dashboard, you’ll be prompted to choose which dimensions and measures to use to populate the data.  
