...
**TL;DR**
 ...
 - It decides [what SQL to generate](/data-modeling/introduction#how-does-it-generate-sql) based on the **database type**, **data models** and **security context** you provide it.
