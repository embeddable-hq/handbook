...
Embeddable leverages [Cube](https://cube.dev/) as its semantic layer. This means you can define, manage, and transform data in a standard format, making it easier to build and scale analytics experiences for your end-users.
...
- `sql_table`: Points to the actual table or view in your database (you can also write SQL)
