...
- define some models ([learn more](/data-modeling/writing-data-models/defining-models)) 🚀.
...
- you can then use them to build your own dashboards in the [no-code editor](/dashboards/building-dashboards) or as [code](/dashboards/dashboards-as-code).
