...
**TL;DR**
 ...
 - It decides what SQL to generate based on the **database type**, **data models** and **security context** you provide it.
 - Defining **data models** is simple once you get your head around a few fundamental concepts.
