...
To try out different security contexts in the no-code builder, define them in your repo at `src/presets/security-contexts.sc.yml` ([here](https://github.com/embeddable-hq/vanilla-components/blob/main/src/presets/security-contexts.sc.yml)):
