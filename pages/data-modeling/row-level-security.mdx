...
1. **SQL-based row-level security** – easiest and fastest way to get started. SQL-based row-level security is the topic of the remainder of this page.
2. **Access Policies** – a more scalable approach to row-level security, and particularly powerful if you start using [Views](/data-modeling/views). Learn more about Access Policies [here](/data-modeling/access-policies).
