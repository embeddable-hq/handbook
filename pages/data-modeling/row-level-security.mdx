...
Embeddable dashboards are [embedded](TODO) in your site via an HTML web component:
...
- The `token` parameter (a **security token**) must be retrieved **server-side** from our [Tokens API](TODO) each time a user accesses your Embeddable dashboard.
...
[Screenshot 2024-02-07 at 18.10.43.png](TODO)
