...
With SQL-based row-level security, you encode security logic directly into your data models using a **security context** — a JSON object you pass when requesting a [security token](/deployment/tokens-api). Use this approach when you need control over how different models filter data.
...
- **[Access Policies](/data-modeling/row-level-security/access-policies)** – a more scalable approach if you start using [Views](/data-modeling/writing-data-models/views) and want role-based security.
