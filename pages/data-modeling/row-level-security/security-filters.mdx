...
- **[Access Policies](/data-modeling/row-level-security/access-policies)** – a more scalable approach, when you have a lot of complex models, particularly powerful when combined with [Views](/data-modeling/writing-data-models/views).
