...
- **[SQL-based row-level security](/data-modeling/row-level-security/sql-based-security)** – the recommended approach if you want fine-grained control of row-level security at the model level.
