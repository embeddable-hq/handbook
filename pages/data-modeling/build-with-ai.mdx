...
<Callout emoji="💡">
Building on top of your models? See [Build dashboards with AI](/dashboards/build-with-ai), [Build components with AI](/component-libraries/build-with-ai), and [Theme with AI](/component-libraries/remarkable-pro/theme-with-ai). Prefer to stay in the browser? The [AI Model Builder](/data-modeling/writing-data-models/generate-data-models) generates a model from a SQL query, right on the docs page.
</Callout>
