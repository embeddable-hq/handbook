...
### Populate the `.env` file: 
   Populate the `.env` file with the correct database [credentials for your database](http://localhost:3000/getting-started/connect-your-database/connections-api/credentials) as per the [Cube.js Environment Configuration](https://cube.dev/docs/reference/configuration/environment-variables).
    ```env
