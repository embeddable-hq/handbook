...
- You can also build dashboards locally to test your models. 
- If you're models are in a [separate repo](/data-modeling/getting-setup#2-storing-models-separately) to your components then, when running `embeddable:dev`, you'll have access to the components available in your online workspace. 
