...
<Callout emoji="💡">
If you'd rather not pre-aggregate your data, increasing your connection's [concurrency](/data/connect-your-database#connection-concurrency) lets more queries run against your database in parallel, which can also help with slow dashboards under concurrent load.
</Callout>
...
- The hash prefix (e.g., `p565c35d4728de3a1d2942475fe26095d2b0b7224de`) is automatically generated using your **workspace id**, [**model version**](/dashboards/saving#models-version), [**security context**](/data-modeling/row-level-security/sql-based-security) and [**environment**](/data/environments).
