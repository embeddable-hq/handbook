...
Use Embeddable’s Caching API to tell Embeddable which security contexts and [pre-aggregations](/data-modeling/caching/pre-aggregations) to refresh and how often.
