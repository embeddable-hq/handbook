...
<Callout emoji="💡">
    If you're connecting to a Redshift database, please contact us to discuss setting up pre-aggregations, as the Redshift driver requires write-access to set up pre-aggregations.
</Callout>
...
### An example without a time dimension
