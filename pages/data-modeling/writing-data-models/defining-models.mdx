...
Prefer to describe your data in plain English? You can [build data models with AI](/data-modeling/build-with-ai) — Embeddable ships a Claude skill that reads your database schema, interviews you for business context, and writes the `.cube.yml` files for you.
...
You can see more data model examples inside [your repo](https://github.com/embeddable-hq/remarkable-pro-boilerplate/tree/main/src/embeddable.com/models). 
...
- `joins`: Defines how to [link models](/data-modeling/writing-data-models/joins) and handle join relationships.
