# Example Data Models: from SQL to Cubes

This section contains some examples of how to translate **SQL** into **data models**. 
...
- But the real power, along with centralising our data logic, is that they unlock many other questions without writing new SQL:
    - Revenue by country.
...
- In models, you define reusable semantics: dimensions (fields), measures (aggregations), joins, and optional segments. 
    - Output is **a flexible dataset** you can slice by time, country, product, etc, without new SQL.

Modeling wins because it gives you:

- **Reusability**: Centralize logic into measures/segments and reuse across dashboards.  
...
Get a headstart translating your existing SQL queries to models by **clicking the "Ask AI" button** in the bottom right of your screen and simply **pasting them in**.  
