...
Remarkable Pro also reads additional `meta` keys to control chart behaviour — such as how the "Other" bucket is aggregated in bar and pie charts. See [Data Model Meta](/component-libraries/remarkable-pro/data-model-meta) for the full reference.
