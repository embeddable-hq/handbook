...
## Version 1.3.4 - Patch Vulnerability, Update Dependencies

- Axios released info about a software vulnerability and released an update. While Embeddable was not affected by this vulnerability, we're nonetheless updating to the latest version.
- Updates VC v1 to the latest Embeddable SDKs

## Version 1.3.3 - Remove Dependency

- We had a dependency that's not actually used. It has been removed. This should not cause any issues for users, but if you do encounter any issues after this update, please reach out to us in our [Community Slack](https://join.slack.com/t/embeddablecommunity/shared_invite/zt-20b4f6s10-gULqO6riqutJcbUi_FJmZA).

## Version 1.3.2 - Component Previews

- Added support for Embeddable's upcoming Component Previews feature, allowing users to see live previews of components when selecting them in the Embeddable dashboard builder.

## Version 1.3.1 - Style Custom Canvas UI

- Added a new, optional theme property that allows users to customize the appearance of the Custom Canvas UI using CSS variabales. This includes colors, fonts, and other visual aspects of the UI. For more information, please see [Styling Custom Canvas in Vanilla Components](/legacy/vanilla-components/styling-custom-canvas).
...
## Version 1.2.1 - Time Zones
  - Added [support for Time Zones](/component-libraries/build-components/loading-data#params) to Vanilla Components (this was added as v1.2.0 but was not released).
...
## Version 1.1.5 - Custom Granularities
  ...
  - Added support for custom granularities via Cube.js data models. This means you can now add e.g. "Last 15 minutes" or "Last 18 days" as options in the Granularity Picker and Date Range Picker w/ Granularity components. You can find more instructions on the [Extending Types](/component-libraries/build-components/extending-types) documentation page.
