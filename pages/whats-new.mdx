...
### 1. Export dashboards as PDF

You can now render a published dashboard server-side and download it as a **print-quality PDF** using the new [Dashboard Export API](/deployment/dashboard-export).
