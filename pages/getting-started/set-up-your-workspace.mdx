...
```
Then run the following to push the code bundle (from the [previous step](/getting-started/download-repo#set-your-region)) to your workspace:

```bash
npm run embeddable:push
```

If you later want to do this via CI/CD, you can use the following:
