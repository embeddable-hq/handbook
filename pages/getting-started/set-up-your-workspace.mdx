...
This uploads your **data models** and **components** to your team **workspace** so you can use them in the Embeddable platform to build a dashboard (notice the [/components](https://github.com/embeddable-hq/embeddable-boilerplate/tree/main/src/embeddable.com/components/examples) and [/models](https://github.com/embeddable-hq/embeddable-boilerplate/tree/main/src/embeddable.com/models) folders in your repo).
