...
Let’s walk through creating a **basic dashboard** in Embeddable - from adding your first component to embedding the result.
...
<div style={{ position: "relative", paddingBottom: "56.782334384858046%", height: 0, marginTop: "20px" }}>
      <iframe
        src="https://www.loom.com/embed/041f9947644245d5bed940a2d46bc6ca?sid=b3d41e99-9f69-440c-8e93-4174e95c0f60"
        frameBorder="0"
        allowFullScreen
...
- **Connect your data**: Securely [connect your database](/getting-started/connect-your-database).