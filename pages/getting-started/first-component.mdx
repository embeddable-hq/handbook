...
1. Inside `src/embeddable.com` in your [repo](/getting-started/download-repo), create a folder called `components`.
2. Inside this folder, create a new folder called `ExampleDropdown` and a file called `index.tsx`.  
