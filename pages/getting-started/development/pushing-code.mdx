...
To make your [data models](/data-modeling/defining-models) and [components](/component-libraries/build-components/defining-components) available in the dashboard builder, you need to push them to your Embeddable Workspace.
