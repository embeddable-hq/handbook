...
To make your [data models](/data-modeling/writing-data-models/defining-models) and [components](/component-libraries/build-components/defining-components) available in the dashboard builder, you need to push them to your Embeddable Workspace.

You can do this by running the [**push command**](/getting-started/development/pushing-code#push-command), which, by default, pushes both data models and components. 
...
When building locally using [`embeddable:dev`](/getting-started/development/local-environment): 
...
You can also push your models and components using your API key, which is especially useful for integrating into your **CI/CD pipeline**. You can also pass an email explicitly, and attach a push message that cen be seen in your Embeddable Workspace.
...
<Callout emoji="💡">
If you're using Powershell, you may need to put the -- in double quotes, like so:
