...
This starter library comes as a single NPM package (it's already in the `package.json` `dependencies` in the boilerplate repo you downloaded earlier) and has full support for everything Embeddable does, including [using themes](/development/theming).
