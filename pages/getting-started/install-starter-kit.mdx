...
Open `embeddable.config.ts` and **uncomment** the `componentLibraries` line [here](https://github.com/embeddable-hq/embeddable-boilerplate/blob/main/embeddable.config.ts):
```js
