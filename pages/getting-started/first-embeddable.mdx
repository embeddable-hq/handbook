...
3. In your code repo, open `embedding-preview.cjs` ([here](https://github.com/embeddable-hq/vanilla-components/blob/main/src/scripts/embedding-preview.cjs)).  
...
<CardGrid>
  <LinkCard title="Complete the homework challenge" href="/getting-started/first-component" icon=""/> 
</CardGrid>
