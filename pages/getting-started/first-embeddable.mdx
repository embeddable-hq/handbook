...
3. In your code repo, open `embedding-preview.cjs` ([here](https://github.com/embeddable-hq/embeddable-boilerplate/blob/main/src/embeddable.com/scripts/embedding-preview.cjs)).  
