...
Getting started with the AI endpoints is straightforward but requires the following initial steps. For a more complete description, see our [Custom Canvas](/self-serve/custom-canvas/introduction) documentation.
...
<ImageGrid width='100%' images={["/img/custom-canvas/custom-canvas-button.png"]}/>
...
<ImageGrid width='100%' images={["/img/custom-canvas/custom-canvas-datasets.png"]}/>
...
<ImageGrid width='100%' images={["/img/custom-canvas/custom-canvas-add-template.png"]}/>
...
<ImageGrid width='100%' images={["/img/custom-canvas/preview.png"]}/>

### Create a security token

You can learn more about creating a security token on our [Tokens Api Page](/deployment/tokens-api).
