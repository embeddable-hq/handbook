...
<Callout emoji="⚠️">
**Important note:** you must have Custom Canvas enabled on your dashboard and at least one dataset defined and enabled within Custom Canvas in order to use these endpoints. Otherwise, the API endpoints won’t be able to query your data!
</Callout>
