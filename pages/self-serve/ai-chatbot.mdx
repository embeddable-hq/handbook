...
- **Standalone chat** — render only the chat, with no visible dashboard. The AI still answers questions and previews charts in the conversation. See [Standalone chat](#standalone-chat-no-visible-dashboard).
