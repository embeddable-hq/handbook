...
If you use Vanilla Components, you will be provided with a complete default theme under the hood (the same colors and appearance you can see on [our example components page](https://embeddable.com/components)), and can then override as many or as few values as you want, within what the theme supports. This is a much larger variety of values than was previously available to change, and we’ll list them all in an appendix to this document, but if all you want to do is change a few chart colors and the font, your theme object could look like this:
