...
By default, running the [**push command**](/development/pushing-code#push-command) will push both data models and components. 

But, you can also push them separately. To do this, in your `embeddable.config` file, simply set:
