...
Your models must contain the same values to use the new granularity options. See [implementing extended granularities in data models](#implementing-extended-granularities-in-data-models) below for details.

### Update Custom Components

Any custom components that use the `granularity` type must be updated to reference your new options. See [implementing extended granularities in custom components](#implementing-extended-granularities-in-custom-components) below for details.
</Steps>

## Implementing Extended Granularities in Data Models
...
## Implementing Extended Granularities in Custom Components
