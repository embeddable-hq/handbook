...
<Callout type="tip">
**Want your dashboard to load faster? ⚡️**

```html
<link rel="preconnect" href="https://static-data.<region>.embeddable.com" crossorigin>
```

**Why this helps:** Adding a preconnect hint tells the browser to start the DNS lookup, TCP handshake, and TLS negotiation early before it encounters the script tag. This can save 100-300ms of connection time, making your dashboard appear faster.
</Callout>
