...
The **Versions API** allows you to programmatically list all saved versions of a specific dashboard (Embeddable) in your workspace. This is useful for managing deployments, rolling back changes, or promoting versions through your development workflow.
...
{
  "tags": {
    "latest": { "version": "v3", "updated-at": "2025-06-27T09:31:42.125Z" },
...
- **`tags.latest`**: The most recently saved version and when it was last updated. Always present if at least one version has been saved.
...
- The API returns the last 30 saved versions, ordered by `saved-at` timestamp.
