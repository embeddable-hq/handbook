...
If you’re reading this, it’s probably because you want your **end-users** (e.g. your customers) to be able to **build their own dashboards**.  We use the following terminology throughout this page:
...
![Image showing a list of dashboards and a "Create new dashboard" button](/img/TODO.png)
