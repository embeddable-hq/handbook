...
**Custom Canvas** empowers **your end-users** to build **their own dashboards** inside your product.  You can configure it as described [here](/self-serve/custom-canvas) and it will work **out of the box**.  However, there are several customisation options that you will likely want to consider.
