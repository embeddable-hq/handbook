...
[Learn More about deploying with saved versions](/deployment/versions).

  **Note**: If you don't specify `savedVersion`, Embeddable will use the latest version of the dashboard that has been published to the 'Production' tag.
