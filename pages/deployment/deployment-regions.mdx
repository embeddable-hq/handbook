...
In your code repo, you'll need to update your `embeddable.config.js` file ([here](https://github.com/embeddable-hq/embeddable-boilerplate/blob/main/embeddable.config.ts)) to point to the correct region:
