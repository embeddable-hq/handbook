...
- [Quickstart](/getting-started/quick-start-guide) - clone the starter repo and connect it to Embeddable
- [Explore your workspace](/getting-started/your-workspace) - find your way around the platform
...
- [Build your first dashboard](/getting-started/first-embeddable) - assemble your first dashboard
...
- [Build a custom component](/development/introduction) - write your own React components
