...
<Callout emoji="‼️">
  Vanilla Components are now deprecated in favor of [Remarkable Pro](/component-libraries/remarkable-pro). We recommend using Remarkable Pro for all new projects, but if you have an existing implementation with Vanilla Components, you can still use the theming system as described in this tutorial.
</Callout>
