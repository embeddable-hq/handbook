...
<Callout emoji="‼️">
  Vanilla Components are now deprecated in favor of [Remarkable Pro](/component-libraries/remarkable-pro). We recommend using Remarkable Pro for all new projects, but if you have an existing implementation with Vanilla Components, you can still follow along with this tutorial to build a custom chart.
</Callout>
